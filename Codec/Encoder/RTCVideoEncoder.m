...
/**
 settings
 */
@property(nonatomic , strong )RTCVideoEncoderSettings *settings;
...
void compressionOutputCallback(void *encoder,
    ...
    RTCVideoEncoder *videoEncoder = (__bridge RTCVideoEncoder *)encoder;
    if (status != noErr) {
        return;
    }
...
- (BOOL)configWithSettings:(RTCVideoEncoderSettings *)settings onQueue:(nonnull dispatch_queue_t)queue{
...
- (BOOL)resetCompressionSession:(RTCVideoEncoderSettings *)settings {
...
- (void)configureCompressionSession:(RTCVideoEncoderSettings *)settings{
